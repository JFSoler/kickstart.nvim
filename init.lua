...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- vim.keymap.set('n', '<LEADER>jd', builtin.lsp_definitions()<CR>', {noremap=true, silent=true})
      -- vim.keymap.set('n', '<LEADER>jv', builtin.lsp_definitions({jump_type="vsplit"})<CR>', {noremap=true, silent=true})
